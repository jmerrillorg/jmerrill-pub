...
test('executive recovery dispatch cannot send attachmentless or unbranded author-review packages', () => {
  ...
  assert.match(dispatch, /interiorProof', 'reviewInstructions', 'authorResponseMechanism', 'packageManifest', 'authorCoverMessage/)
  assert.match(dispatch, /editedManuscript', 'editorialMemo', 'reviewInstructions', 'authorResponseMechanism', 'packageManifest', 'authorCoverMessage/)
