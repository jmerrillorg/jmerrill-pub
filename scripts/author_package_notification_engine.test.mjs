...
const checks = [
  ...
  },
  {
    ...
    pass: () =>
      ...
      engine.includes('The complete manuscript or proof for this review is attached to this email') &&
      engine.includes('Please review the attached materials for this step') &&
      ...
      !engine.includes('current author-facing files') &&
      !engine.includes('current publishing stage') &&
      !engine.includes('project history') &&
  ...
  },
  {
    ...
    pass: () =>
      ...
      engine.includes('HUMAN_LAST_MILE_POLICY') &&
      engine.includes('ATTACHMENT_RECIPIENT_SURFACE_INVALID') &&
      engine.includes('ATTACHMENT_MANUSCRIPT_PROFILE_INVALID') &&
      engine.includes('Generated by:') &&
