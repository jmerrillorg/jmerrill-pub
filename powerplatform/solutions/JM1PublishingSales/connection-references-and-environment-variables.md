...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Dataverse | Required for D365/Dataverse solution components | None in baseline | JM1-Dev | JM1-Core | No direct secret in solution | Governed identity / environment connection | Solution import and runtime connection must bind per environment. |
| Dynamics 365 Sales | Through Dataverse/Sales components | None in baseline | JM1-Dev dependency parity required | JM1-Core | No direct secret in solution | Microsoft first-party app install/licensing | Sales components must exist before import. |
