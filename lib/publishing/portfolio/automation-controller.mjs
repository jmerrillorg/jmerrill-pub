...
function classifyRecord(record, normalized, commercial, authorGate, runtime) {
  ...
  if (
    ...
    return classification(
      ...
      'Bind exact Editorial Review approval evidence to the governed source artifact before Developmental Editing execution',
      'DEVELOPMENTAL_EDITING_EXACT_APPROVAL_EVIDENCE_REQUIRED',
      'EDITORIAL_PRODUCTION',
      'DEVELOPMENTAL_EDITING',
      ACTION_LEVELS.OPERATOR_EXCEPTION,
      'P0',
    )
  }
