const POLICY_ID = "JM1-ACS-SENDER-IDENTITY-v2";
...
const REGISTRY = Object.freeze({
  ...
  JMF: profile({
    ...
    ccRequired: true,
    ccAddress: "financial@jmerrill.one",
  ...
  JMFN: profile({
    ...
    ccRequired: true,
    ccAddress: "foundation@jmerrill.one",
  ...
  JMPRODUCTIONS: profile({
    ...
    ccRequired: true,
    ccAddress: "productions@jmerrill.one",
