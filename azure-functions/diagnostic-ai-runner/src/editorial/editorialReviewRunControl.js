...
const REVIEW_RUN_STATUS = Object.freeze({
  ...
  WAITING_FOR_PROSPECT_PACKAGE_SELECTION: "Waiting for Prospect Package Selection",
...
const REVIEW_RUN_ACTION = Object.freeze({
  ...
  PROSPECT_PACKAGE_SELECTION_PENDING: "PROSPECT_PACKAGE_SELECTION_PENDING",
...
const TERMINAL_OR_ACTIVE_STATUSES = new Set([
  ...
  REVIEW_RUN_STATUS.WAITING_FOR_PROSPECT_PACKAGE_SELECTION,
