...
const TRACK_B_ADOPTION_CANDIDATES = Object.freeze([
  ...
  Object.freeze({
    titleId: "number-23-and-me",
    title: "Number 23 and Me",
    authorName: "Wayne Pounds",
    imprint: "JM Works",
    genre: "Memoir",
    isbnPaperback: "978-1-950719-10-5",
    isbnHardcover: "",
    isbnEbook: "978-1-950719-12-9",
    isbnAudiobook: "",
    formats: ["Paperback", "eBook"],
    relationshipState: "Active Author",
    workspaceMode: "Published Author Workspace",
  ...
  Object.freeze({
    titleId: "your-brain-has-too-much-what-mommy",
    title: "Your Brain Has Too Much What, Mommy??",
    authorName: "Essence Unique",
    imprint: "JM Little",
    genre: "Children's",
    isbnPaperback: "978-1-954414-78-5",
    isbnHardcover: "",
    isbnEbook: "978-1-954414-79-2",
    isbnAudiobook: "",
    formats: ["Paperback", "eBook"],
    relationshipState: "Active Author",
    workspaceMode: "Published Author Workspace",
  ...
  Object.freeze({
    titleId: "7-step-jumpstart-to-becoming-your-best-self",
    title: "7 Step Jumpstart to Becoming Your Best Self",
    authorName: "Johnson Settles",
    imprint: "JM Works",
    genre: "Self-Help",
    isbnPaperback: "978-1-954414-74-7",
    isbnHardcover: "",
    isbnEbook: "978-1-954414-73-0",
    isbnAudiobook: "",
    formats: ["Paperback", "eBook"],
    relationshipState: "Active Author",
    workspaceMode: "Published Author Workspace",
  ...
  Object.freeze({
    titleId: "ordinary-people-searching-for-greatness",
    title: "Ordinary People Searching for Greatness",
    authorName: "Earline Neal",
    imprint: "JM Works",
    genre: "Inspirational",
    isbnPaperback: "978-1-954414-86-0",
    isbnHardcover: "978-1-954414-87-7",
    isbnEbook: "978-1-954414-88-4",
    isbnAudiobook: "",
    formats: ["Paperback", "Hardcover", "eBook"],
    relationshipState: "Active Author",
    workspaceMode: "Published Author Workspace",
  ...
  Object.freeze({
    titleId: "focus-trust-and-follow",
    title: "Focus, Trust, and Follow",
    authorName: "Shana Byrd",
    imprint: "J Merrill Publishing",
    genre: "Faith",
    isbnPaperback: "978-1-950719-49-5",
    isbnHardcover: "",
    isbnEbook: "978-1-950719-50-1",
    isbnAudiobook: "",
    formats: ["Paperback", "eBook"],
    relationshipState: "Active Author",
    workspaceMode: "Published Author Workspace",
  ...
  Object.freeze({
    titleId: "hodge-podge-of-life",
    title: "Hodge Podge of Life",
    authorName: "Mildred Beard",
    imprint: "JM Works",
    genre: "Memoir",
    isbnPaperback: "978-1-954414-93-8",
    isbnHardcover: "",
    isbnEbook: "978-1-954414-94-5",
    isbnAudiobook: "",
    formats: ["Paperback", "eBook"],
    relationshipState: "Active Author",
    workspaceMode: "Published Author Workspace",
  ...
  Object.freeze({
    titleId: "pretty-wings",
    title: "Pretty Wings",
    authorName: "Natasha Gilchrist",
    imprint: "JM Works",
    genre: "Poetry",
    isbnPaperback: "978-1-954414-08-2",
    isbnHardcover: "",
    isbnEbook: "978-1-954414-07-5",
    isbnAudiobook: "",
    formats: ["Paperback", "eBook"],
    relationshipState: "Active Author",
    workspaceMode: "Published Author Workspace",
  ...
  Object.freeze({
    titleId: "the-hood",
    title: "The Hood",
    authorName: "Randall Beverly",
    imprint: "JM Works",
    genre: "Fiction",
    isbnPaperback: "978-1-950719-47-1",
    isbnHardcover: "",
    isbnEbook: "978-1-950719-48-8",
    isbnAudiobook: "",
    formats: ["Paperback", "eBook"],
    relationshipState: "Active Author",
    workspaceMode: "Published Author Workspace",
  ...
  Object.freeze({
    titleId: "a-blended-family",
    title: "A Blended Family",
    authorName: "Shecara Norris",
    imprint: "JM Works",
    genre: "Inspirational",
    isbnPaperback: "978-1-954414-12-9",
    isbnHardcover: "978-1-954414-42-6",
    isbnEbook: "978-1-954414-11-2",
    isbnAudiobook: "",
    formats: ["Paperback", "Hardcover", "eBook"],
    relationshipState: "Active Author",
    workspaceMode: "Published Author Workspace",
  ...
  Object.freeze({
    titleId: "the-master-s-piece",
    title: "The Master's Piece",
    authorName: "Sylvia Benson",
    imprint: "J Merrill Publishing",
    genre: "Faith",
    isbnPaperback: "978-1-954414-48-8",
    isbnHardcover: "978-1-961475-01-4",
    isbnEbook: "978-1-954414-47-1",
    isbnAudiobook: "",
    formats: ["Paperback", "Hardcover", "eBook"],
    relationshipState: "Active Author",
    workspaceMode: "Published Author Workspace",
