...
test("author package sender rejects internal metadata in author-facing review notes", async () => {
  const artifacts = [
    {
      jm1pub_editorialartifactid: "artifact-line-manuscript",
      jm1pub_editorialartifactname: "Edited Manuscript - Line Editing - The Long Watch",
      jm1pub_filename: "The Long Watch - Edited Manuscript.docx",
      jm1pub_artifactstatus: 196650002,
      jm1pub_visibility: 196650000,
      "jm1pub_visibility@OData.Community.Display.V1.FormattedValue": "Author Facing",
      jm1pub_repositorydriveid: "drive",
      jm1pub_repositoryitemid: "item-line-docx",
      jm1pub_iscurrentapproved: true
    },
    {
      jm1pub_editorialartifactid: "artifact-internal-review-notes",
      jm1pub_editorialartifactname: "Line Editing Review Notes - The Long Watch",
      jm1pub_filename: "The Long Watch - Review Notes.txt",
      jm1pub_artifactstatus: 196650002,
      jm1pub_visibility: 196650000,
      "jm1pub_visibility@OData.Community.Display.V1.FormattedValue": "Author Facing",
      jm1pub_repositorydriveid: "drive",
      jm1pub_repositoryitemid: "item-internal-notes",
      jm1pub_iscurrentapproved: true
    }
  ];
  ...
  await assert.rejects(
    () => materializeAttachments(
      { stageCode: "LINE_EDITING", titleName: "The Long Watch", artifacts },
      {
        downloadArtifact: async (artifact) => artifact.jm1pub_repositoryitemid === "item-line-docx"
          ? Buffer.from("PK test word/document.xml payload")
          : Buffer.from("Generated by: JM1 Automation\nStage: LINE_EDITING\nSource checksum: abc123\nCorrelation: TARGETED-123")
      }
    ),
    (error) => error.safeCode === "ATTACHMENT_RECIPIENT_SURFACE_INVALID:reviewCoverNote:GENERATED_BY_JM1_AUTOMATION"
  );
});
