...
class BlobBudgetLedger {
  ...
  async recordEvidence(sourceEventId, policyVersion, evidence) {
    ...
    const allowed = {
      ...
      primaryInferenceCostCents: evidence.primaryInferenceCostCents,
      evaluatorCostCents: evidence.evaluatorCostCents,
      totalEventCostCents: evidence.totalEventCostCents,
