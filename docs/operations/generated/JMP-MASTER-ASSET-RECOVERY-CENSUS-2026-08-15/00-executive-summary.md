...
|---|---|---|---|---|---|
| P1 | Establishing Glory: The Library | Jackie Smith, Jr. | ACTIVE_EDITORIAL | WAITING_ON_JMP | Verify latest approved artifact and complete next editorial/author-approval step manually. |
| P1 | The General’s Will and Last Testament | Iyorwuese Hagher | ACTIVE_EDITORIAL | WAITING_ON_JMP | Verify latest approved artifact and complete next editorial/author-approval step manually. |
...
| P1 | The Intentional Leader | Jackie Smith, jr. | EDITORIAL_REVIEW | WAITING_ON_JMP | Prepare or verify prospect Editorial Review and package-selection communication. |
| P1 | The Intentional Leader | Jackie Smith, jr. | EDITORIAL_REVIEW | WAITING_ON_JMP | Prepare or verify prospect Editorial Review and package-selection communication. |
| P1 | The Long Watch | Jackie Smith Jr | ACTIVE_EDITORIAL | WAITING_ON_JMP | Verify latest approved artifact and complete next editorial/author-approval step manually. |
| P1 | Before You Were Born | Sean Crowley | EDITORIAL_REVIEW | WAITING_ON_JMP | Prepare or verify prospect Editorial Review and package-selection communication. |
| P1 | The Long Watch | Jackie Smith, Jr. | ACTIVE_EDITORIAL | WAITING_ON_JMP | Verify latest approved artifact and complete next editorial/author-approval step manually. |
