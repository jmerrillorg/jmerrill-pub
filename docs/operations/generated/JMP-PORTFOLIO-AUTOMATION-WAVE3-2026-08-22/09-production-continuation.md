...
| --- | --- | --- | --- | --- |
| The Intentional Leader | BOOK_PRODUCTION | AUTO_EXECUTABLE | Create/queue governed Full Wrap production work item from certified prerequisites | QUEUE_ALREADY_PRESENT |
