...
| --- | --- | --- | --- | --- |
| DATA_GAP | Establishing Glory: The Library | WAITING_ON_AUTHOR | MISSING_NEXT_ACTION_RULE | Classify exact next governed action from current artifact and author gate |
| Jackie Smith, Jr. | Establishing Glory 2: The Relationship Handbook (2nd Edition) | TERMINAL | MISSING_ARTIFACT_AUTHORITY | Bind current editorial artifact before stage movement |
