# JMP Catalog Reconciliation Worksheet Amendment

Generated: 2026-07-20T12:54:38.319Z
...
| Measure | Count |
|---|---:|
| Existing worksheet rows | 104 |
| Legacy source rows reviewed | 104 |
| Matrix v1.1 governing SKU count | 22 |
| Unique SKUs after amendment | 120 |
| Duplicate rows removed | 0 |
| New rows added | 16 |
| Existing rows amended | 5 |
| Additional unique services discovered | 16 |
| Final row count | 120 |
