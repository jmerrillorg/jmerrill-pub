...
| Production deployment mechanism | OPEN | Protected workflow skeleton exists, but production import is fail-closed until governed federated PAC identity is commissioned. |
