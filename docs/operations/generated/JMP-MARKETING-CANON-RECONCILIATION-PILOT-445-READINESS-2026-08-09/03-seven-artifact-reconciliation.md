# Seven-Artifact Reconciliation

Source treatment: instruction-provided canon-candidate business material. No artifact supersedes Tranches 1-6.

| ID | Artifact | Requirement | Classification | Evidence |
|---|---|---|---|---|
| MR-001 | Readiness & Organic Launch Standard | Map readiness activities to lifecycle-triggered Marketing Opportunities. | ALREADY_IMPLEMENTED | Tranche 4 Marketing Opportunity runtime and marketing calendar. |
| MR-002 | Readiness & Organic Launch Standard | Use Readiness, Organic Launch, Campaign Services as business layers. | BUSINESS_RULE_ENHANCEMENT | Three-layer model filed as canon-candidate inside Strategic Marketing. |
...
| MR-010 | Traditional vs. Hybrid Responsibility Matrix | Traditional/JM Signature JMP spend requires Jackie approval. | BUSINESS_RULE_ENHANCEMENT | Spend authorization guard added. |
| MR-011 | Traditional vs. Hybrid Responsibility Matrix | Shared spend requires both author and Jackie approval. | BUSINESS_RULE_ENHANCEMENT | Spend authorization guard added. |
| MR-012 | Traditional vs. Hybrid Responsibility Matrix | Traditional responsibility is not unlimited spend authority. | CANON_AMENDMENT_REQUIRED | Doctrine clarifies configured or baseline marketing does not authorize spend. |
| MR-013 | Campaign Budget and Stop-Loss Standard | Paid campaigns require objective, budget, cadence, metric, stop condition, and evidence. | RUNTIME_EXTENSION_REQUIRED | Behavioral extension required for Wave C marketing eligibility. |
...
| MR-028 | No-/Low-Cost Priority | Prefer owned, earned, partner, low-cost, then paid with approval. | CANON_AMENDMENT_REQUIRED | Doctrine creates priority rule. |
| MR-029 | Campaign Attribution | Distinguish directly attributable, correlated, and unknown. | BUSINESS_RULE_ENHANCEMENT | Reporting discipline added. |
| MR-030 | Traditional Pay-to-Prioritize Guardrail | Paid marketing cannot buy editorial, production, distribution, rights, or quality-gate priority. | CANON_AMENDMENT_REQUIRED | Doctrine and evidence register preserve this guardrail. |
