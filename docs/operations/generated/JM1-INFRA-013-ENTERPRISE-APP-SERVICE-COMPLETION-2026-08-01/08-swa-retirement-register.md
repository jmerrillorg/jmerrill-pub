...
| `jmerrill-productions` | Held | GATE-W3 Productions production App Service exception |
| `org-to-foundation-redirect` | Held | Redirector replacement not certified |
| `jm1-book-redirector` | Held | Redirector replacement not certified |
| AIC SWA | Out of scope | Separate enterprise |
| Jackie Smith Jr. SWA | Out of scope | Separate personal-brand lane |
