...
2. App Service GitHub Actions release pipeline was added in source but not yet proven by a governed run.
3. Staging health is warm-stable but unstable after deployment/restart before later warm recovery.
