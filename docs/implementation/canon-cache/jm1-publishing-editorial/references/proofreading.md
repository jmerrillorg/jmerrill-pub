...
- Incorrect italics, bolding, or fonts
- Running heads and folios (page numbers)
- Verso/recto sequencing (print)
- Blank page logic ("intentionally left blank")
...
- Flag numerical or symbol discrepancies (do not recalculate)
- Flag broken or split tables caused by layout
...
Do not create or revise alt text.
