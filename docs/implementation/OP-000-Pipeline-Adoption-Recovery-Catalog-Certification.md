...
**Status:** Phase II authorized — Track A pilot implementation candidate for *Establishing Glory: The Library*
...
- *100 Wisdom Lessons for Life and Living* (J. Derrick Johnson, imprint J Merrill Publishing) — standard published-title adoption with populated ISBNs across all four formats.
