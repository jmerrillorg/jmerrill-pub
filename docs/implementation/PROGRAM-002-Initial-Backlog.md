...
|---|---|---|---|---|---|
| OP-000 | Pipeline Adoption, Recovery & Catalog Certification | Adopt legacy/active/published titles into PROGRAM-002's system of record without forcing `/join` or interrupting live commissioning | Phase II Track A pilot certified for *Establishing Glory: The Library* | None for Track A pilot; Track B/C remain deferred | Track A pilot wrote safe historical execution evidence; imprint certified and locked; existing workspace/assets verified; no duplicate workspace/contract/royalty record created; Track B/C remain deferred until separately authorized |
...
**Phase II pilot:** Jackie authorized OP-000 Track A for one title only: *Establishing Glory: The Library* (`JMP-INT-202606-UFYG60`, diagnostic `64e387e0-7e6a-f111-a826-00224820105b`, existing Opportunity `2653fca9-eacd-4c44-b3ed-1764dd5d35aa`). The Track A pilot is now certified. Track B, Track C, and catalog-wide adoption must not begin until separately authorized.
