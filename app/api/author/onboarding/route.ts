...
export async function POST(req: NextRequest) {
  try {
    ...
    const productionSpecifications = {
      ...
      packageIncludedSlotLimit: governedFormatSelection.packageIncludedSlotLimit,
      ...
      selectedIncludedProductForms: governedFormatSelection.selectedIncludedProductForms,
      selectedAddOnProductForms: governedFormatSelection.selectedAddOnProductForms,
      selectedSeparateAuthorizationProductForms: governedFormatSelection.selectedSeparateAuthorizationProductForms,
      selectionBlockers: governedFormatSelection.selectionBlockers,
