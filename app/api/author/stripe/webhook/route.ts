...
export async function POST(req: NextRequest) {
  ...
  if (!classification.process) {
    ...
    const paymentSuccess: PublishingPaymentSuccess = {
      ...
      paymentType: safeEvent.agreementPayment?.paymentType || null,
      authorId: safeEvent.agreementPayment?.authorId || null,
      paymentScheduleId: safeEvent.agreementPayment?.paymentScheduleId || null,
      balanceVersion: safeEvent.agreementPayment?.balanceVersion || null,
      scheduledObligationId: safeEvent.agreementPayment?.scheduledObligationId || null,
      contractBalanceBeforeCents: safeEvent.agreementPayment?.balanceBeforeCents || null,
      contractBalanceAfterCents: safeEvent.agreementPayment?.balanceAfterCents || null,
      agreementPaymentMetadataStatus: safeEvent.agreementPaymentMetadataStatus,
