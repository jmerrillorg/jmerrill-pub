...
export const onboardingFields: Field[] = [
  ...
  },
  {
    ...
    options: [
      ...
      'JM Signature (publisher invitation only)',
  ...
  { name: 'manuscriptLink', label: 'Manuscript file link', note: 'Use a private OneDrive, Google Drive, Dropbox, or other private file link if available.' },
...
export const financialFields: Field[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'Secure online payment setup', value: 'Stripe/processor onboarding when available' },
      'Not sure yet',
    ],
  },
